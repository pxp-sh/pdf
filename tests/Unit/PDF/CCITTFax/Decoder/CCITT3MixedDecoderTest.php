...
final class CCITT3MixedDecoderTest extends TestCase
{
    ...
    public function test_decode_with_k_equals_4(): void
    {
        ...
        $ccitt3MixedDecoder = new CCITT3MixedDecoder($params, $testData);

        try {
            $lines = $ccitt3MixedDecoder->decode();
    ...
    public function test_decode_to_stream(): void
    {
        ...
        $ccitt3MixedDecoder = new CCITT3MixedDecoder($params, $compressedData);

        $outputStream = fopen('php://temp', 'rb+');

        try {
            $bytesWritten = $ccitt3MixedDecoder->decodeToStream($outputStream);
    ...
    public function test_decode_alternating_1d_2d_lines(): void
    {
        $params = new Params(
            k: 1,
            endOfLine: false,  // Every other line must be 1D
            columns: 100,
            rows: 10,
        );
    ...
    public function test_decode_with_stream_input(): void
    {
        ...
        $ccitt3MixedDecoder = new CCITT3MixedDecoder($params, $inputStream);
        $outputStream       = fopen('php://temp', 'rb+');
    ...
    public function test_get_width_and_height(): void
    {
        ...
        $ccitt3MixedDecoder = new CCITT3MixedDecoder($params, "\x00");

        $this->assertEquals(1728, $ccitt3MixedDecoder->getWidth());
        $this->assertEquals(2200, $ccitt3MixedDecoder->getHeight());
    }
    ...
    public function test_invalid_stream_throws_exception(): void
    {
        ...
        $ccitt3MixedDecoder->decodeToStream('not a stream');
    }
    ...
    public function test_streaming_memory_efficiency(): void
    {
        ...
        try {
            $ccitt3MixedDecoder->decodeToStream($stream);
    ...
    public function test_various_k_values(int $k): void
    {
        ...
        $ccitt3MixedDecoder = new CCITT3MixedDecoder($params, str_repeat("\x00", 100));
        $this->assertEquals(100, $ccitt3MixedDecoder->getWidth());
        $this->assertEquals(50, $ccitt3MixedDecoder->getHeight());
    }
    ...
    public function test_reference_line_usage(): void
    {
        ...
        $params = new Params(
            k: 10,
            endOfLine: false,  // Allow many 2D lines
            columns: 50,
            rows: 20,
        );
    ...
    public function test_decode_with_byte_alignment(): void
    {
        $params = new Params(
            ...
            columns: 1728,
            rows: 10,  // EOL padded to byte boundary
        );
