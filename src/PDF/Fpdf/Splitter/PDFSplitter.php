...
final class PDFSplitter
{
     ...
     */
    private function buildSinglePagePdf(\PXP\PDF\Fpdf\Tree\PDFObjectNode $pageNode): string
    {
        $pageDict = $pageNode->getValue();
        if (!$pageDict instanceof PDFDictionary) {
            throw new FpdfException('Page object is not a dictionary');
        ...
        $pagesDict->addEntry('/Count', new \PXP\PDF\Fpdf\Object\Base\PDFNumber(1));
     ...
     * @return \PXP\PDF\Fpdf\Object\Dictionary\ResourcesDictionary New resources dictionary with resolved references
     */
    private function copyResourcesWithReferences(
        PDFDictionary $resourcesDict,
        PDFDocument $newDoc,
        int &$nextObjectNumber
    ): \PXP\PDF\Fpdf\Object\Dictionary\ResourcesDictionary {
     ...
     *
     * @param \PXP\PDF\Fpdf\Object\PDFObjectInterface $obj Object to copy
     ...
     * @return \PXP\PDF\Fpdf\Object\PDFObjectInterface Copied object
     */
