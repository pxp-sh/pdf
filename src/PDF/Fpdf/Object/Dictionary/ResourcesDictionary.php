...
final class ResourcesDictionary extends PDFDictionary
{
     ...
     * Add a font resource.
     */
    public function addFont(string $fontName, PDFReference|int $fontObjectNumber): self
    {
     ...
     */
    public function addXObject(string $xObjectName, PDFReference|int $xObjectNumber): self
    {
